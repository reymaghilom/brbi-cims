...
@section('title', 'Bank / Coop target unavailable')

@section('content')
    {{-- Rendered with a 404 status for a missing Bank / Coop target. Deliberately generic: the
    ...
    <section class="ui-panel mx-auto max-w-lg p-5 text-center sm:p-6" role="alert" data-bank-target-unavailable>
        ...
        <h1 class="mt-4 text-lg font-bold text-brand-sidebar">Bank / Coop target unavailable</h1>
