...
<tr data-repeater-row @if(data_get($row, '_delete')) hidden @endif>
    ...
    <td><label for="properties-{{ $index }}-units-available" class="sr-only">Total units available</label><input id="properties-{{ $index }}-units-available" name="properties[{{ $index }}][units_available]" type="number" min="0" step="1" value="{{ data_get($row, 'units_available') }}" class="ui-control"></td>
    <td><label for="properties-{{ $index }}-units-with-tenants" class="sr-only">Units with tenants</label><input id="properties-{{ $index }}-units-with-tenants" name="properties[{{ $index }}][units_with_tenants]" type="number" min="0" step="1" value="{{ data_get($row, 'units_with_tenants') }}" class="ui-control"></td>
