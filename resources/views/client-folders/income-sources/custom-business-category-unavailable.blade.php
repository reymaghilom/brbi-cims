...
@section('title', 'Custom Business Category unavailable')

@section('content')
    <section class="ui-panel mx-auto max-w-lg p-5 text-center sm:p-6" role="alert" data-custom-business-category-unavailable>
        ...
        <h1 class="mt-4 text-lg font-bold text-brand-sidebar">Custom Business Category unavailable</h1>
