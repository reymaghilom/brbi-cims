{{--
    ...
    Each cell's data-label repeats its column header. On phones the same row (the same inputs the
    repeater and SaveCibiReport rely on) is shown as a labelled card instead of a wide table row, and
    that label is what names each value there (see the CIBI loan card rules in app.css).
--}}
