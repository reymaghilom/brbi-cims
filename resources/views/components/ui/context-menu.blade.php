...
<details data-context-menu {{ $attributes->class('group relative inline-block') }}>
    ...
    @endisset
    <div class="absolute right-0 z-30 mt-2 min-w-48 rounded-card border border-ui-border bg-surface p-1.5 shadow-float" role="menu" data-context-menu-panel>{{ $slot }}</div>
</details>
