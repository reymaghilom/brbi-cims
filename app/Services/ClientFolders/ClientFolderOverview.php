...
class ClientFolderOverview
{
    public function for(ClientFolder $folder, ?CoMaker $activePerson = null): array
    {
        ...
        $folder = ClientFolder::query()
            ->with([
                ...
                'coMakers:id,client_folder_id,full_name,first_name,middle_name,last_name,suffix,relationship_to_applicant,contact_number,address,revision',
            ])
            ->withCount([
    ...
    private const ACTIVITY_LABELS = [
        ...
        'residence_check.created' => ['label' => 'Residence Check added', 'icon' => 'home', 'person' => true],
        'residence_check.updated' => ['label' => 'Residence Check updated', 'icon' => 'home', 'person' => true],
        'residence_check.deleted' => ['label' => 'Residence Check removed', 'icon' => 'trash', 'detail' => 'location', 'person' => true],
        'business_check.created' => ['label' => 'Business Check added', 'icon' => 'building', 'detail' => 'business_name', 'person' => true],
        'business_check.updated' => ['label' => 'Business Check updated', 'icon' => 'building', 'detail' => 'business_name', 'person' => true],
